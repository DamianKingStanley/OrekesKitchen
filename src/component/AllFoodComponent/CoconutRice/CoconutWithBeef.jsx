...
import coconutricewithbeef from "../../../assest/coconutricewithbeef.jpg";
...
const CoconutWithChicken = () => {
  ...
  const product = {
    name: "Coconut Rice with Meat",
    price: 2000,
    image: coconutricewithbeef,
  };
      ...
      <section className="AllFoodSingle">
        <section className="AllFood">
          ...
          <div>
            ...
            <p> (A plate of Coconut rice with a piece of meat) </p> <br />
